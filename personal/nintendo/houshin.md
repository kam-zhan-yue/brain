...
I want to make games that instill that same wonder and joy into chidren and adults alike. I want to have the same impact that these games have had on me on the next generation of children. And I wholeheartedly believe that this is a trait only found in Nintendo games.

I want to dedicate my life to delivering smiles to people and creating ways to experience joy that doesn't exist in this world. yet.

私の人生を通して、貴社のゲームは私の中に子供のような好奇心、比類なきゲームへの愛情を育んできた。何百万人のも子どもたちと同じように、ポケモン、ゼルダ、スマブラで育った。これらの不思議な世界と魅力的な物語に夢中になった。「ベレス オブ ザ ワイルド」とプレイし、、その体験に感動したことが、ゲーム開発者を志すきっかけとなった。
...
Anatisの3Dオンレールカードゲームを自作した。
のアーケードみたいなオンレールのカードゲームを自作した。プレイヤーはダンジョンを自動的に移動し、敵のいる部屋を攻略する。各部屋で、プレイヤーは魔法のカードを受け取り、カードを組み合わせることで、範囲攻撃、状態異常、属性効果などの特殊効果が得られる。与えられたカードセットを使い、その部屋を攻略する方法を考え出す必要があり、アクションパズルゲームのような要素がある。
プレイヤーは自動にダンジョンを探索し、各エンカウンタに
博物館とゲームの統合を研究するため、「RE：Collect」というウェブゲームを開発した。博物館で歩きながら、展示に基づいたストーリーを体験し、アイテムを集め、選択肢を通じて異なるエンディングに着ける
