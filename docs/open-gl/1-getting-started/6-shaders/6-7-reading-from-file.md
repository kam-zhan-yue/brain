We use C++ filestreams to read the content from the file into several `string` objects.
...
Then we need to compile and link the shaders. 
...
Finally using and utility functions.
```c++
